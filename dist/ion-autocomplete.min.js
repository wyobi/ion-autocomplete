        ...
        return {
            ...
            link: function (f, j, k, l) {
                ...
                d.when().then(function () {
                    ...
                    var k = h(angular.element(i))(f);
                    c.find("body").append(k), n.getItemValue = function (a, b) {
                    ...
                    n.showModal = function () {
                        ...
                        angular.element(c[0].querySelector("div.ion-autocomplete-container." + n.randomCssClass)).css("display", "none"), a.release(), f.$deregisterBackButton && f.$deregisterBackButton(), l = !1
                    };
                    var o = {moved: !1, startX: 0, startY: 0}, p = function (a) {
                        o.moved = !1, "undefined" != typeof a.originalEvent && (a = a.originalEvent), o.startX = a.touches[0].clientX, o.startY = a.touches[0].clientY
                    }, q = function (a) {
                        "undefined" != typeof a.originalEvent && (a = a.originalEvent), (Math.abs(a.touches[0].clientX - o.startX) > 10 || Math.abs(a.touches[0].clientY - o.startY) > 10) && (o.moved = !0)
                    }, r = function (a) {
                        o.moved || (a.preventDefault(), a.stopPropagation(), n.showModal())
                    }, s = function (a, b, c) {
                    ...
                    "false" == n.manageExternally && (j.bind("touchstart", p), j.bind("touchmove", q), j.bind("touchend click focus", r)), n.cancelClick = function () {
                        ...
                        a && angular.isFunction(n.modelToItemMethod) && (angular.isArray(a) ? (n.selectedItems = [], angular.forEach(a, function (a) {
                            t(a, !0)
                        })) : t(a))
