        ...
        return {
            ...
            link: function (f, j, k, l) {
                ...
                n.templateUrl ? i(n.templateUrl).then(function (a) {
                    ...
                    if (void 0 !== a && angular.isFunction(n.itemsMethod)) {
                        n.showLoadingIcon = !0;
                ...
                n.showModal = function () {
                    ...
                    angular.element(c[0].querySelector("div.ion-autocomplete-container." + n.randomCssClass)).css("display", "none"), n.searchQuery = void 0, a.release(), f.$deregisterBackButton && f.$deregisterBackButton(), p = !1
                };
                var q = {moved: !1, startX: 0, startY: 0}, r = function (a) {
                    ...
                    q.moved || (a.preventDefault(), a.stopPropagation(), n.fetchSearchQuery("", !0), n.showModal())
                }, u = function (a, b, c) {
                ...
                "false" == n.manageExternally && (j.bind("touchstart", r), j.bind("touchmove", s), j.bind("touchend click focus", t)), n.cancelClick = function () {
                    n.hideModal(), angular.isFunction(n.cancelButtonClickedMethod) && n.cancelButtonClickedMethod({
                        callback: {
                            selectedItems: n.selectedItems.slice(),
                            componentId: n.componentId
                        }
                    })
                }, f.$watchCollection("viewModel.externalModel", function (a) {
                    return angular.isArray(a) && 0 == a.length ? (n.selectedItems = [], m.$setViewValue(n.selectedItems), void m.$render()) : void(a && angular.isFunction(n.modelToItemMethod) && (angular.isArray(a) ? (n.selectedItems = [], angular.forEach(a, function (a) {
                        v(a)
                    })) : v(a)))
                }), m.$render = function () {
