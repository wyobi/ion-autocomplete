        ...
        return {
            ...
            link: function (f, j, k, l) {
                ...
                n.showModal = function () {
                    q || (a.retain(), angular.element(c[0].querySelector("div.ion-autocomplete-container." + n.randomCssClass)).css("display", "block"), f.$deregisterBackButton = g.registerBackButtonAction(function () {
                        n.hideModal()
                    }, 300), p.length > 0 && (p[0].focus(), setTimeout(function () {
                        p[0].focus()
                    }, 0)), b.resize(), q = !0)
                }, n.hideModal = function () {
                    angular.element(c[0].querySelector("div.ion-autocomplete-container." + n.randomCssClass)).css("display", "none"), a.release(), f.$deregisterBackButton && f.$deregisterBackButton(), q = !1
                };
                var r = {moved: !1, startX: 0, startY: 0}, s = function (a) {
                    r.moved = !1, "undefined" != typeof a.originalEvent && (a = a.originalEvent), r.startX = a.touches[0].clientX, r.startY = a.touches[0].clientY
                }, t = function (a) {
                    "undefined" != typeof a.originalEvent && (a = a.originalEvent), (Math.abs(a.touches[0].clientX - r.startX) > 10 || Math.abs(a.touches[0].clientY - r.startY) > 10) && (r.moved = !0)
                }, u = function (a) {
                    r.moved || (a.preventDefault(), a.stopPropagation(), n.showModal())
                }, v = function (a, b, c) {
                ...
                "false" == n.manageExternally && (j.bind("touchstart", s), j.bind("touchmove", t), j.bind("touchend click focus", u)), angular.element(c[0].querySelector("div.ion-autocomplete-container." + n.randomCssClass + " button")).bind("click", function () {
