...
!function () {
    "use strict";
    angular.module("ion-autocomplete", []).directive("ionAutocomplete", ["$ionicBackdrop", "$ionicScrollDelegate", "$document", "$q", "$parse", "$ionicPlatform", "$compile", "$templateRequest", function (a, b, c, d, e, f, g, h) {
        return {
            ...
            link: function (i, j, k, l) {
                ...
                n.selectItem = function (a) {
                    n.items = [], n.searchQuery = void 0, "true" === n.multipleSelect ? (w(n.selectedItems, n.itemValueKey, n.getItemValue(a, n.itemValueKey)) || (n.selectedItems = n.selectedItems.concat([a])), m.$setViewValue(n.selectedItems), m.$render()) : (m.$setViewValue(a), m.$render(), n.hideModal()), angular.isFunction(n.itemsClickedMethod) && n.itemsClickedMethod({
                        callback: {
                            item: a,
                ...
                }, i.$watch("viewModel.searchQuery", function (a) {
                    if (void 0 !== a && ("" == a && (n.items = []), angular.isFunction(n.itemsMethod))) {
                        n.showLoadingIcon = !0;
                        var c = {query: a};
                        n.componentId && (c = {query: a, componentId: n.componentId});
                        var e = d.when(n.itemsMethod(c));
                        e.then(function (a) {
                            a && a.data && (a = a.data), n.items = n.getItemValue(a, n.itemsMethodValueKey), b.resize(), n.showLoadingIcon = !1
                        }, function (a) {
                            return d.reject(a)
                        })
                    }
                ...
                n.showModal = function () {
                    r || (a.retain(), angular.element(c[0].querySelector("div.ion-autocomplete-container." + o)).css("display", "block"), i.$deregisterBackButton = f.registerBackButtonAction(function () {
                        n.hideModal()
                    }, 300), q.length > 0 && (q[0].focus(), setTimeout(function () {
                        q[0].focus()
                    }, 0)), b.resize(), r = !0)
                }, n.hideModal = function () {
                    angular.element(c[0].querySelector("div.ion-autocomplete-container." + o)).css("display", "none"), a.release(), i.$deregisterBackButton && i.$deregisterBackButton(), r = !1
                };
                ...
                "false" == n.manageExternally && (j.bind("touchstart", t), j.bind("touchmove", u), j.bind("touchend click focus", v)), angular.element(c[0].querySelector("div.ion-autocomplete-container." + o + " button")).bind("click", function (a) {
                    n.searchQuery = void 0, n.hideModal()
                }), n.ngModel && angular.isFunction(n.modelToItemMethod) && ("true" === n.multipleSelect && angular.isArray(n.ngModel) ? angular.forEach(n.ngModel, function (a) {
                    x(a)
