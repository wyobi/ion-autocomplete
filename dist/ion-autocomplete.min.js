            ...
            link: function (f, j, k, l) {
                ...
                d.when().then(function () {
                    ...
                    c.find("body").append(l), n.getItemValue = function (a, b) {
                        ...
                        n.selectedItems = n.selectedItems.slice(), m.$setViewValue(n.selectedItems), m.$render(), angular.isDefined(k.itemsRemovedMethod) && n.itemsRemovedMethod({
                            callback: {
                                item: b,
                                selectedItems: n.selectedItems.slice(),
                                componentId: n.componentId
                        ...
                        if (void 0 !== a && angular.isDefined(k.itemsMethod)) {
                            ...
                            f.then(function (a) {
                                a && (a && a.data && (a = a.data), n.searchItems = n.getItemValue(a, n.itemsMethodValueKey), b.resize())
                            }, function (a) {
                                return d.reject(a)
                            }).then(function () {
                                n.showLoadingIcon = !1
